...
const SEARCH_API_KEY = "22336235ae8cd5ba3de3feef1417f230";//process.env.REACT_APP_TMDB_API_KEY;
    ...
    return(
        ...
        <div className=" flex justify-center items-start h-fit w-full">
            <label className="input input-bordered flex items-center gap-2 ml-10 my-1 h-14 w-full shadow-lg shadow-black/20">
                ...
                <input type="text" value={searchQuery} className="grow " placeholder="Search" onChange={(e)=> {
