...
export default function Homepage(){
    ...
    return(
        ...
        <div ref={stickyElementRef} className="pointer-events-none flex justify-center items-center sticky top-[63px] sm:top-1 left-1/4 my-10 z-40 h-14 w-[99vw]">
        <div className={`h-fit w-full transition-all duration-400 ${IsSticky? 'mx-[12%] sm:mx-[28%]':'mx-[10%] sm:mx-[27%]'} mt-2`}>
