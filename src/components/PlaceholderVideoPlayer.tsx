...
<div className={` absolute top-5 left-0 opacity-100 translate-y-0 z-50`}>
    ...
    <div className={`absolute w-full h-fit bottom-0 pb-3 sm:pb-0 rounded-lg transition-all duration-300 opacity-100 translate-y-0 z-50`}>
        ...
        <button className='btn btn-ghost px-2' >
         <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 24 24" fill="gray" stroke="gray" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>
         </button>
